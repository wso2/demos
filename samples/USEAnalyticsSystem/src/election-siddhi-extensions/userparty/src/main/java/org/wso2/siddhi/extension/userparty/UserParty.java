...
public class UserParty extends StreamProcessor {
    ...
    protected List<Attribute> init(AbstractDefinition inputDefinition,
        ...
        if (!(attributeExpressionExecutors[1] instanceof ConstantExpressionExecutor)) {
            throw new UnsupportedOperationException("Required a Constant, but found a otherparameter");
        } else {
        ...
        if (!(attributeExpressionExecutors[2] instanceof ConstantExpressionExecutor)) {
            ...
            datasourceName = (String) attributeExpressionExecutors[2].execute(null);
            if("".trim().equals(datasourceName)||datasourceName==null){
                throw new UnsupportedOperationException("Data source Cannot be NULL"); 
            }
