...
public class WorldCloudText extends StreamProcessor {
    private static final Logger LOGGER = LoggerFactory.getLogger(WorldCloudText.class);
    ...
    protected List<Attribute> init(AbstractDefinition inputDefinition,
        ...
        if ("NLP".equalsIgnoreCase(option)) {
            ...
            try {
                ...
                LOGGER.error("Error in load Model in word cloud extenstion ", e);
            }
