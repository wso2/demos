package org.wso2.siddhi.extension.fbmentions;
 ...
 * */
public class CandidateMention extends StreamProcessor {
    private static final Logger LOGGER = LoggerFactory.getLogger(CandidateMention.class);
